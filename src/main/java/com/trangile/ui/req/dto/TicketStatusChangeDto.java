...
public class TicketStatusChangeDto {
	...
	public TicketStatusChangeDto() {
		
	}

	public TicketStatusChangeDto(String ticketId, String project, String description, String status, String remarks,
			LocalDateTime assignedOn, String assignedTo, String resolvedBy, LocalDateTime resolvedOn, String createdBy,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TicketStatusChangeDto other = (TicketStatusChangeDto) obj;
	...
	public String toString() {
		return "TicketStatusChangeDto [ticketId=" + ticketId + ", project=" + project + ", description=" + description
